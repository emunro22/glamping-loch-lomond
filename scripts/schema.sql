...
VALUES
  ('rose', 'The Rose Pod', 'The one with the BBQ hut',
   'The Rose Pod has its own hot tub right on the decking, open to the sky, plus sole access to our Scandinavian BBQ hut, so you can cook outdoors whatever the weather is doing. Inside it is the same story as its twin: a proper double bed, a pull-out sofa bed, and an en-suite with a walk-in shower.',
   '["Own hot tub, open-air on the decking","Exclusive use of the BBQ hut (addable to your stay)","Double bed plus double pull-out sofa bed","En-suite with walk-in shower","Electric frying pan, kettle and toaster","Dog friendly, with farm walks from the door"]'::jsonb,
   '75351', '70916', 4, 1),
  ('thistle', 'The Thistle Pod', 'The one with the sauna',
   ...
   '["Own hot tub under a covered gazebo","Exclusive access to the barrel sauna","Double bed plus double pull-out sofa bed","En-suite with walk-in shower","Two-ring cooker top, air fryer, kettle and toaster","Dog friendly, with farm walks from the door"]'::jsonb,
   '75350', '70916', 4, 2)
...
INSERT INTO site_content (key, heading, body) VALUES
  ...
  ('extras', 'Hot tub & sauna',
   'Both pods have their own hot tub, set up a little differently — the Rose Pod''s sits open under the sky, the Thistle Pod''s under a covered gazebo. The Thistle Pod also has sole access to our Scandinavian barrel sauna.'),
  ('view', 'The view',
